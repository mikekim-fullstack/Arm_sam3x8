...
void CANListener1::gotFrame1(CAN_FRAME */*frame*/, int /*mailbox*/)
{

}

void CANListener1::gotFrameFD(CAN_FRAME_FD *frame, int mailbox)
{

}

void CANListener1::setCallback(uint8_t mailBox)
{
...
void CANListener1::removeCallback(uint8_t mailBox)
{
	if ( mailBox < numFilters )
	{
...
void CANListener1::setGeneralHandler()
{
	generalCBActive = true;
}

void CANListener1::removeGeneralHandler()
{
	generalCBActive = false;
}

void CANListener1::initialize()
{
   callbacksActive = 0;
}

bool CANListener1::isCallbackActive(int callback)
{
...
void CANListener1::setNumFilters(int numFilt)
{
	numFilters = numFilt;
}
#endif
...
boolean CAN_COMMON::attachObj(CANListener1 *listener)
{
...
boolean CAN_COMMON::detachObj(CANListener1 *listener)
{
	for (int i = 0; i < SIZE_LISTENERS; i++)
	{
