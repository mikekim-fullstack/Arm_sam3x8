...
public:
  ...
  virtual void gotFrame1(CAN_FRAME *frame, int mailbox);
...
public:
    ...
    bool attachObj(CANListener1 *listener);
	bool detachObj(CANListener1 *listener);
...
protected:
	CANListener1 *listener[SIZE_LISTENERS];
