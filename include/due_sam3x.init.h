...
#ifndef _DUE_SAM3X_INIT_H_
#define _DUE_SAM3X_INIT_H_
#define __SAM3X8E__
...
#endif
#ifndef millis()
#define millis() GetTickCount() // Conflict with Aruduino.h
#endif
/********************************************************************************
...
// void SysTick_Handler(void) { TimeTick_Increment(); } // Conflict with Arduino core
